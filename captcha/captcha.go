...
// prevent information leaks. Information leaks can be exploited by adversaries
// to perform a timing side-channel attack
// create a stub for each argument of ChallengeUser
